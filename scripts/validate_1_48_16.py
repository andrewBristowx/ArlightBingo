...
checks = {
    'pom.xml': ['<version>1.48.16</version>'],
    'src/main/resources/plugin.yml': ['version: 1.48.16'],
...
if errors:
    ...
    raise SystemExit(1)
print(f'OK: ArlightBingo 1.48.16 validado ({len(java_files)} archivos Java).')
