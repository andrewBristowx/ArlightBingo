...
/** Structural checks that prevent a visually broken 1.48.8 template from becoming READY. */
final class OverworldCampaignAudit148 {
    ...
    static Summary auditWorld(World world, Registry registry, Site village,
        ...
        if (!failures.isEmpty()) {
            ...
            throw new IllegalStateException("Auditoría estructural 1.48.8 rechazada: "
