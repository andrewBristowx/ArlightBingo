...
import static com.arlight.bingo.listeners.OverworldCampaignArchitecture147.*;

final class OverworldCampaignStructures147 {
    private OverworldCampaignStructures147() { }
    ...
    static List<BlockEdit> village(Site site, Report report) {
        ...
        farmDistrict(out, site.x() - 7, lowerY, site.z() + 57, 31, 17, false);
        farmDistrict(out, site.x() - 44, lowerY, site.z() + 61, 17, 13, true);
        ...
        lowWall(out, site, 74, Material.COBBLESTONE_WALL);
        ...
        for (int[] lamp : new int[][]{{-20,18},{20,18},{-20,-15},{20,-15},{0,31},{0,-27},{55,4}}) {
            OverworldCampaignTerrain147.lamp(out, site.x() + lamp[0],
    ...
    static List<BlockEdit> residential(Site site, Report report) {
        ...
        farmDistrict(out, site.x() - 6, y, site.z() - 34, 23, 15, false);
        farmDistrict(out, site.x() + 25, y, site.z() - 34, 15, 13, true);
